...
@pytest.mark.parametrize(
    ...
    [
        ...
        "\ndef mutation(x): return abs(x) < 1e-9\n",
        "\ndef mutation(x): return math.isclose(x, 0, abs_tol=1e-9)\n",
        "\ndef mutation():\n    for _ in (): pass\n",
        "\ndef mutation():\n    while False: pass\n",
        "\ndef mutation(): return [item for item in ()]\n",
        "from cnrs.canonical_periodic import CanonicalPeriodicExpansion\n",
        "from cnrs.witnesses import validate_division_witness\n",
        "\ndef mutation(): return CanonicalPeriodicExpansion.from_gaussian_fraction((1, 0), (1, 0))\n",
        "\ndef mutation(witness): return validate_division_witness(witness)\n",
        "\ndef mutation(witness):\n    witness[\"schema\"] = \"changed\"\n    return witness\n",
        "\ndef mutation(payload):\n    payload[\"algorithm\"] = \"changed\"\n    return payload\n",
