...
Version 0.18.0 changes no public name, signature, import path, or result type.
`add_cnrs` and `cnrs_add` retain the released 14-state relation and
...
The controlling documents are `V018_ARCHITECTURE_FREEZE.md` and
`V018_EXACT_ADDITION_SUBTRACTION_API_CONTRACT.md`. All v0.17 and earlier
public interfaces remain available.
